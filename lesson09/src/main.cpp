...
void test(std::string name) {
    // TODO 1 скопируйте сюда функцию test из предыдущего задания (lesson09)
    // TODO 2 не забудьте заменить lesson09 в путях отладочных картинок на lesson09:
    // Ctrl+R (это как Ctrl+F но для автоматической замены) -> lesson09 -> lesson09 -> Replace All
