...
void test1() {
    ...
    for (auto el: matches10) {
        distances10.push_back(el[0].distance);
    }
...
//        }
        ...
        //сравнение дистанции со средней фильтрует где-то половину
        // k-ratio test фильтрует большинстово
        // сравнение обратного сопоставления фильтрует где-то 60%
        // можно оставить только k-ratio test
