...
void task2() {
    ...
    rassert(array2d.size() == 0, 29183910740174)
    ...
    rassert(row0.size() == 3, 29183339107)
    ...
    rassert(array2d.size() == 1, 29183910740174)
...
void task3() {
    ...
    std::cout<<"type 2 numbers from 1 to 20 s\n";
    int rows, cols;
    std::cin>>rows>>cols;
    ...
    rassert(rows>=1 && rows<=20 && cols>=1 && cols<=20, 928310);
